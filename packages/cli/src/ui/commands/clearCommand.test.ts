...
vi.mock('@tiecode/tie-cli-core', async () => {
  const actual = await vi.importActual('@tiecode/tie-cli-core');
  return {
    ...actual,
    uiTelemetryService: {
...
import type { GeminiClient } from '@tiecode/tie-cli-core';
import { uiTelemetryService } from '@tiecode/tie-cli-core';
