...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @tiecode/tie-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @tiecode/tie-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @tiecode/tie-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @tiecode/tie-cli@latest';
    return {
