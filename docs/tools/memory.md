...
The tool appends the provided `fact` to a special `TIE.md` file located in the user's home directory (`~/.tie/TIE.md`). This file can be configured to have a different name.
